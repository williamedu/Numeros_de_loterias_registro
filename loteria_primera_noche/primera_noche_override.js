...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (lotteryType === 'primera_noche') {
        console.log('La Primera Noche detectado - Aplicando override de orden de números');
        ...
        function applyNumberInversion() {
            ...
            if (winningNumbersDisplay && winningNumbersDisplay.children.length === 3) {
                ...
                if (currentContent !== lastProcessedContent && !currentContent.includes('data-inverted')) {
                    ...
                    console.log('  Agregando en posición 1:', firstNumber.textContent, '(era posición 2)');
                    winningNumbersDisplay.appendChild(firstNumber); // va primero
                    ...
                    console.log('  Agregando en posición 3:', secondNumber.textContent, '(era posición 1)');
                    winningNumbersDisplay.appendChild(secondNumber);  // va tercero
